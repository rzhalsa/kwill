<template>
    <v-app-bar app class="gradient-navbar">
        ...
        <!-- Github, Light/Dark mode, and Settings buttons -->
        
        
        <!-- GitHub logo -->
        <a href="https://github.com/rzhalsa/kwill" style="color: inherit !important;" class="v-btn v-btn--icon app-btn ml-3">
        ...
        <v-btn icon="mdi-cog" class="mr-2" to="/account"></v-btn>
        <div>
            <!-- Account drop down -->
