<template>
	<v-card class="gradient-home" height="100%">
		<v-col class="ma-16 d-flex flex-column align-center">
			<!-- Title -->
			<img class="mb-3 logo-img-home" src="../assets/icon-small-margin.png"
				v-if="theme.global.name.value === 'kwillTheme'" />
				...
				<v-row>
					<v-col cols="8">
						<v-row>
							<v-col>
								<!-- Welcome section -->
								<v-card elevation="6" class="gradient-db-card"
									style="margin-left: 5%; margin-top:5%; outline: solid black 3px;">
									<v-card-title class="text-center text-h4">Welcome!</v-card-title>
									<v-divider opacity=".7" thickness="3" gradient
										style="margin-left: 7%; margin-right: 7%;"></v-divider>
									<v-card-item>
										<v-card-text style="padding-top: 2%;" class="text-center text-h5">
											<div class="mb-6 card-text">Welcome to Kwill! Kwill is a webapp which can
												generate, store, and update user-created smart <i>Dungeons and
													Dragons</i> character sheets. You can also download your characters
												locally.</div>
											<div class="mb-6 card-text">Additional smart functionality includes
												automated field calculations, real-time spell tooltips, and much more!
											</div>
											<div class="mb-6 card-text">New? Create a free account <b><router-link
														to="/createaccount">here</router-link></b> to save your
												characters.</div>
						...
						<v-row>
							<v-col>
								<!-- Why Kwill? section -->
								<v-card elevation="6" class="gradient-db-card"
									style="margin-bottom: 5%; margin-left: 5%; outline: solid black 3px;">
									<v-card-title class="text-center text-h4">Why Kwill?</v-card-title>
									<v-divider opacity=".7" thickness="3" gradient
										style="margin-left: 7%; margin-right: 7%;"></v-divider>
									<v-card-item>
										<v-card-text style="padding-top: 2%;" class="text-center text-h5">
											<div class="mb-6 card-text">Dungeons and Dragons is a fantasy roleplaying
												game where you create characters and go on adventures with others.</div>
											<div class="mb-6 card-text">As players ourselves, we want creating a
												character to be as hassle-free as possible. For this reason we built
												Kwill.</div>
											<div class="mb-6 card-text">The added smart-functionality on both our online
												sheet, as well as the smart version of the local sheet solve many common
												friction points while playing D&D. No more frantically looking up spells
												before your turn!</div>
										</v-card-text>
									</v-card-item>
								</v-card>
							</v-col>
					...
					<v-col cols="4">
						...
						<v-card elevation="6" class="gradient-db-card"
							style="margin-right: 10%; margin-top:10%; outline: solid black 3px;">
							...
							<v-card-item>
								<v-row class="justify-center ma-2">
									<router-link to="/characters" style="text-decoration: none; color: inherit;">
										<v-card>
											...
											<v-card-item class="justify-center"><img src="../assets/community.png"
													style="height:120px; width: 120px;" /></v-card-item>
										</v-card>
									</router-link>
								</v-row>
								<v-row class="justify-center ma-2">
								...
								<div class="d-flex justify-center my-8">
									<v-btn color="secondary" v-tooltip="'Download local sheet'" icon="mdi-download"
										rounded @click="showDownloadDialog = true" style="width: 120px;">
									</v-btn>
								</div>
							</v-card-item>
						</v-card>
